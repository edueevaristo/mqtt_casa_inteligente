...
/* Tópicos específicos da aplicação */
#define MQTT_TOPIC_LUMINOSIDADE "casa/externo/luminosidade"
#define MQTT_TOPIC_TEMPERATURA "casa/externo/temperatura"

/* GPIOs de controle */
#define GPIO_LUZES 18
#define GPIO_AR_CONDICIONADO 19

/* Função para configurar callback de mensagens recebidas */
